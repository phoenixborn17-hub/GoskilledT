...
export default async function AdminOverviewPage() {
  ...
  const stages = ["NEW", "WEBINAR_REGISTERED", "CONTACTED", "CONVERTED", "LOST"];
  ...
  return (
    <section className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-3 lg:grid-cols-4">
        <Stat label="Users" value={o.users.toLocaleString("en-IN")} href="/admin/users" />
        <Stat label="Paid orders" value={o.paidOrders.toLocaleString("en-IN")} href="/admin/payments" />
        <Stat label="Revenue (paid)" value={formatINR(o.revenueInPaise)} href="/admin/payments" />
        <Stat label="Pending review" value={o.pendingReview.toLocaleString("en-IN")} href="/admin/review-queue" />
      </div>
