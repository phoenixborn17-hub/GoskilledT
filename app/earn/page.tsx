...
export const metadata = pageMetadata({
  ...
  description: "Our affiliate program opens after review. Join the waitlist to be first to know when it's live.",
  path: "/earn",
});
...
const POINTS = [
  { Icon: ShieldCheck, title: "Built on trust", body: "You'll only ever share skills you believe in — we sell skills, not dreams." },
  { Icon: ClipboardCheck, title: "Opens after review", body: "The program is being finalised and reviewed. Details and terms will be shared before it opens." },
  { Icon: BellRing, title: "Waitlist first", body: "People on the waitlist are the first to know the day it goes live." },
];
    ...
    <>
      ...
      <main className="mx-auto grid w-full max-w-4xl gap-8 px-4 py-12 md:grid-cols-2">
        <section>
          ...
          <h1 className="mt-3 font-heading text-3xl font-extrabold leading-tight">Share what you learn</h1>
          {/* COPY: draft — no earnings promise, no numbers */}
          <p className="mt-2 text-charcoal/70">
            We&apos;re building a way for learners to share GoSkilled courses with others. It opens once our review is
            complete — no dates or numbers yet. Join the waitlist and you&apos;ll be first to hear.
          </p>
