  ...
  return (
    <section aria-labelledby="earn-heading" className="space-y-6">
      ...
      <Card className="text-center">
        <div
          className="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-full bg-gold text-charcoal"
          aria-hidden
        >
        ...
        <CardDescription>
          The referral programme is being finalised and will open once approved.
          Focus on learning for now — we&apos;ll notify you here when it&apos;s
          ready.
        </CardDescription>
      </Card>
    </section>
