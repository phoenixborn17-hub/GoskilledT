...
| 10 | Welcome / Lesson-0 video | lms (Getting-Started course) · /welcome | Content | PENDING | Founder | Slot BUILT — hidden "Getting Started" course + free-preview Lesson 0 ("GoSkilled kaise kaam karta hai"), mock video in dev (YouTube-unlisted allowed, DR-022) | 60–90s recorded intro | LAUNCH | Pre-launch | DR-030 spec FROZEN + built (GPS-M2 delta); only the founder recording remains. |
