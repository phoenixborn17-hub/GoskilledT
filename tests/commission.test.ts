...
import { commissionForLevel, totalCommission, commissionIdempotencyKey } from "../modules/affiliate/commission";
...
describe("ledger double-entry invariant", () => {
  ...
  it("balance = sum of entries", () => {
    expect(balanceOf([{ amountInPaise: 90000 }, { amountInPaise: -50000 }])).toBe(40000);
  });
});
